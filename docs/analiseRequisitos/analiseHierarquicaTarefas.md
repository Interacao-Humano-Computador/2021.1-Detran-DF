...
| -- | -- |
| 0. Agendar Serviço <br/> 1+2+3>4 | input: formulário com dados do cidadão, dados do agendamento e data e hora.<br/> plano: informar os dados e agendar serviço.|
...
| Objetivo/Operações | Problemas e Recomendações |
| -- | -- |
| 0. Consultar Débitos Veículo <br/> 1+2>3 | input: formulário com placa e renavam do veículo. <br/> plano: Consultar todos os débitos do veículo. |
...
| Objetivo/Operações | Problemas e Recomendações |
| -- | -- |
| 0. Solicitar CNH Definitiva | input: formulário com código, registro, nome e data de nascimento. <br/> plano: obter borderô de taxa de troca de habilitação. |
